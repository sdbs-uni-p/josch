 ...
 */
public class ParamClientTest extends ClientTest {
  ...
  public void setup() {
    ...
    validDto = new ConnectionInfoDto("localhost", "27017");
    validDto.setDatabase("clientTest");

    // create the valid blank dto
    validBlankDto = new ConnectionInfoDto("localhost", "27017");

    // create the invalid dto
    invalidDto = new ConnectionInfoDto("validDocument_validSchemabar", "12");
  }
